...
def Eivind_1():
    ...
    for t_, tmax_ in enumerate(tmax):   #Loop over all tmax
        ...
        plt.tight_layout()
    plt.savefig(f"{len(tmax)}_{Evolution_type}_{Hamiltonian_type}_{Integrator}_{N}_{dt}_Eivind_4_2.pdf")
    plt.show()
...
"Speedup av kode"
"- Forhåndslagre verdier for mu, delta, w, istedenfor å bygge H helt på ny"
